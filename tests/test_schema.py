...
def test_null_type(schema_from_registry):
    ...
    errors = validate_null_type(
        ...
        no_null=True,
        allow_null=["/items/properties/technical note", "/properties/entityType/allOf/0/if/not/properties/subtype",\
         "/properties/entityType/allOf/1/if/not/properties/subtype", "/properties/entityType/allOf/2/if/not/properties/subtype"]
    )
    assert errors == 0
