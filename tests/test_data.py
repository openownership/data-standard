...
@pytest.mark.parametrize('json_path', [
    ...
    '../examples/ua/os-01-ua-bp-entity-natural-person-domestic-direct.json',
    '../examples/ua/os-01-ua-ms1-entity-natural-person-domestic-direct.json',
    '../examples/ua/os-02-ua-bp-direct-entity-natural-person-foreign-direct.json',
    '../examples/ua/os-02-ua-ms1-direct-entity-natural-person-foreign-direct.json',
    '../examples/ua/os-03-ua-bp-indirect-natural-person-via-domestic-entity.json',
    '../examples/ua/os-03-ua-ms1-indirect-natural-person-via-domestic-entity.json',
    '../examples/ua/os-04-dc-02-ua-bp-indirect-natural-person-via-unknown-entity.json',
    '../examples/ua/os-04-dc-02-ua-ms1-indirect-natural-person-via-unknown-entity.json',
    '../examples/ua/os-04-dc-03-ua-bp-unknown-beneficial-owner.json',
    '../examples/ua/os-04-dc-03-ua-ms1-unknown-beneficial-owner.json',
    '../examples/ua/os-04-dc-05-ua-bp-exempt-from-disclosure-beneficial-owner.json',
    '../examples/ua/os-04-ua-bp-indirect-natural-person-via-foreign-entity.json',
    '../examples/ua/os-04-ua-ms1-indirect-natural-person-via-foreign-entity.json'
])
