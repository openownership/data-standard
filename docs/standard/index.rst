...
The BODS schema, defined using `JSON Schema 2020-12 <https://json-schema.org/>`_, describes the data model. The :ref:`Schema browser <schema-browser>` shows how the schema's objects and properties fit together. The :ref:`Schema reference <schema-reference>` includes an A-Z of objects, detailing their properties and related codelists. 
