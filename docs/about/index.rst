...
This website contains the specification of `version 0.3 of the Beneficial Ownership Data Standard (BODS)
<https://standard.openownership.org/en/0.3.0/>`__ plus support for its use. 
...
An open :doc:`data standard working group <governance>` of data experts, beneficial ownership specialists and other interested parties also provides advice and helps guide the development of BODS.
...
See the `project issue tracker <https://github.com/openownership/data-standard/issues>`__ for a list of open bugs, issues and features.
